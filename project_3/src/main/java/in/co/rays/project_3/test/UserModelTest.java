...
public class UserModelTest {
	...
	public static void addTest() throws Exception {
		...
		dto.setDob(sdf.parse("30-07-1995"));
		dto.setConfirmPassword("Rajesh@123");
		dto.setPassword("Rajesh@123");
		dto.setLogin("rajeshkumarhrm40@gmail.com");
		dto.setGender("male");
		...
		dto.setRoleId(1);
		dto.setMobileNo("8982213237");
		dto.setRegisteredIP("rajeshkumarhrm40@gmail.com");
		dto.setLoginIP("rajeshkumarhrm40@gmail.com");
